...
export type OptionControlKind = "color" | "number" | "range" | "select" | "toggle" | "text" | "icon";
...
export const COMPONENT_OPTION_SPECS: Record<string, OptionSpec[]> = {
  ...
  violin: [
    { key: "split", label: "split by group", control: "toggle", group: "Layout", default: true },
    { key: "showBox", label: "box overlay", control: "toggle", group: "Marks", default: true },
    { key: "showMean", label: "mean dot", control: "toggle", group: "Marks", default: true },
    { key: "showPoints", label: "outliers", control: "toggle", group: "Marks", default: true },
    { key: "bandwidth", label: "smoothing", control: "range", group: "Marks", default: 2, min: 0, max: 5, step: 1 },
    { key: "fillOpacity", label: "fill opacity", control: "range", group: "Marks", default: 0.55, min: 0.1, max: 1, step: 0.05 },
    { ...HEIGHT, default: 320 },
    SPAN,
    ...GRID,
  ],
  box: [
    { key: "showMean", label: "mean dot", control: "toggle", group: "Marks", default: true },
    { key: "showPoints", label: "outliers", control: "toggle", group: "Marks", default: true },
    { key: "fillOpacity", label: "fill opacity", control: "range", group: "Marks", default: 0.6, min: 0.1, max: 1, step: 0.05 },
    { ...HEIGHT, default: 300 },
    SPAN,
    ...GRID,
  ],
  threshold: [
    { key: "curve", label: "curve", control: "select", group: "Path", default: "monotoneX", choices: CURVE_CHOICES },
    { key: "aboveColor", label: "above fill", control: "color", group: "Difference", default: "#7fd1b9" },
    { key: "aboveOpacity", label: "above opacity", control: "range", group: "Difference", default: 0.55, min: 0, max: 1, step: 0.05 },
    { key: "belowColor", label: "below fill", control: "color", group: "Difference", default: "#e0aaff" },
    { key: "belowOpacity", label: "below opacity", control: "range", group: "Difference", default: 0.55, min: 0, max: 1, step: 0.05 },
    { key: "line1Color", label: "series 1 color", control: "color", group: "Series 1", default: "#e2e8f0" },
    { key: "line1Width", label: "series 1 width", control: "range", group: "Series 1", default: 2, min: 0.5, max: 6, step: 0.5 },
    { key: "line1Dash", label: "series 1 dashed", control: "toggle", group: "Series 1", default: false },
    { key: "showLine1", label: "show series 1", control: "toggle", group: "Series 1", default: true },
    { key: "line2Color", label: "series 2 color", control: "color", group: "Series 2", default: "#94a3b8" },
    { key: "line2Width", label: "series 2 width", control: "range", group: "Series 2", default: 1.5, min: 0.5, max: 6, step: 0.5 },
    { key: "line2Dash", label: "series 2 dashed", control: "toggle", group: "Series 2", default: true },
    { key: "showLine2", label: "show series 2", control: "toggle", group: "Series 2", default: true },
    { ...HEIGHT, default: 300 },
    SPAN,
    ...GRID,
  ],
  bands: [
    { key: "band", label: "band", control: "select", group: "Band", default: "ci95", choices: ["none", "sd", "se", "ci95"] },
    { key: "bandOpacity", label: "band opacity", control: "range", group: "Band", default: 0.18, min: 0, max: 0.6, step: 0.02 },
    { key: "lineWidth", label: "line width", control: "range", group: "Lines", default: 2.5, min: 0.5, max: 6, step: 0.5 },
    { key: "glow", label: "glow", control: "toggle", group: "Lines", default: true },
    { key: "glowStrength", label: "glow strength", control: "range", group: "Lines", default: 3, min: 0, max: 8, step: 0.5 },
    { key: "curve", label: "curve", control: "select", group: "Lines", default: "monotoneX", choices: CURVE_CHOICES },
    { key: "showPoints", label: "markers", control: "toggle", group: "Lines", default: false },
    { key: "showLegend", label: "legend", control: "toggle", group: "Interaction", default: true },
    { key: "crosshair", label: "crosshair tooltip", control: "toggle", group: "Interaction", default: true },
    { key: "bandGradient", label: "gradient band", control: "toggle", group: "Band", default: false },
    { key: "palette", label: "palette (csv hex)", control: "text", group: "Lines", default: "" },
    { key: "xLabel", label: "x tooltip label", control: "text", group: "Interaction", default: "" },
    { ...HEIGHT, default: 340 },
    SPAN,
    ...GRID,
  ],
  panels: [
    { key: "columns", label: "columns", control: "range", group: "Layout", default: 2, min: 1, max: 3, step: 1 },
    { key: "solidSeries", label: "solid series", control: "text", group: "Series", default: "Bounce" },
    { key: "palette", label: "palette (csv hex)", control: "text", group: "Series", default: "" },
    { key: "lineWidth", label: "line width", control: "range", group: "Series", default: 2, min: 0.5, max: 5, step: 0.5 },
    { key: "curve", label: "curve", control: "select", group: "Series", default: "natural", choices: CURVE_CHOICES },
    { key: "glow", label: "glow", control: "toggle", group: "Series", default: true },
    { key: "glowStrength", label: "glow strength", control: "range", group: "Series", default: 2.6, min: 0, max: 8, step: 0.5 },
    { key: "band", label: "band", control: "select", group: "Series", default: "none", choices: ["none", "sd", "se", "ci95"] },
    { key: "bandOpacity", label: "band opacity", control: "range", group: "Series", default: 0.14, min: 0, max: 0.6, step: 0.02 },
    { key: "showInset", label: "inset box plots", control: "toggle", group: "Inset", default: true },
    { key: "insetRef", label: "inset dataset", control: "text", group: "Inset", default: "" },
    { key: "insetPanelField", label: "inset panel field", control: "text", group: "Inset", default: "panel" },
    { key: "insetMetricField", label: "inset metric field", control: "text", group: "Inset", default: "metric" },
    { key: "insetValueField", label: "inset value field", control: "text", group: "Inset", default: "diff" },
    { key: "toolbar", label: "toolbar", control: "toggle", group: "Interaction", default: true },
    { key: "showLegend", label: "legend", control: "toggle", group: "Interaction", default: true },
    { key: "crosshair", label: "crosshair tooltip", control: "toggle", group: "Interaction", default: true },
    { ...HEIGHT, label: "panel height", default: 230, min: 140, max: 380, step: 10 },
    SPAN,
    ...GRID,
  ],
  sparkline: [
  ...
  flow: [
    { key: "background", label: "background", control: "select", group: "Canvas", default: "dots", choices: ["dots", "lines", "cross", "none"] },
    { key: "controls", label: "controls", control: "toggle", group: "Canvas", default: true },
    { key: "minimap", label: "minimap", control: "toggle", group: "Canvas", default: false },
    { key: "fitView", label: "fit on load", control: "toggle", group: "Canvas", default: true },
    { key: "interactive", label: "interactive", control: "toggle", group: "Canvas", default: true },
    { key: "edgeType", label: "edge type", control: "select", group: "Edges", default: "smoothstep", choices: ["bezier", "straight", "step", "smoothstep"] },
    { key: "animated", label: "animated", control: "toggle", group: "Edges", default: true },
    { key: "edgeColor", label: "edge color", control: "color", group: "Edges", default: "#64748b" },
    { key: "nodeColor", label: "node accent", control: "color", group: "Nodes", default: "#6366f1" },
    { key: "nodeRadius", label: "node radius", control: "range", group: "Nodes", default: 12, min: 0, max: 24, step: 1 },
    { ...HEIGHT, default: 360 },
    SPAN,
  ],
};
